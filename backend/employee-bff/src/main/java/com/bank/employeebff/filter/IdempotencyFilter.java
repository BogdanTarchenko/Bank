package com.bank.employeebff.filter;

import com.bank.employeebff.model.IdempotencyRecord;
import com.bank.employeebff.repository.IdempotencyRepository;
...
public class IdempotencyFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (existing.isPresent()) {
            ...
            log.info("[IDEMPOTENCY] Повторный запрос с ключом {}", idempotencyKey);
